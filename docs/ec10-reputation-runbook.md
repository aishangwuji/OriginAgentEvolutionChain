...
EC-10 does not modify `VerificationRegistry.testnetReputation`. Address-level testnet reputation remains available for the existing challenge flow.
...
EC-10 does not add token rewards, staking, slash mechanics, DAO governance, public testnet deployment, or natural-person uniqueness.
