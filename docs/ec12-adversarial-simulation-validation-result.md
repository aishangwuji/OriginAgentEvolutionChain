...
EC-12 is a simulation harness. It does not attack public systems, scan third-party infrastructure, add token rewards, add staking, add slashing, add DAO governance, or mutate Passport reputation.
