...
EC-6 extends the EC-5 Anvil live transaction loop with event indexing and audit bundle generation. It does not change contracts and does not add a database, explorer, public testnet, token, DAO, StakeVault, RewardVault, or OriginAgent client integration.
