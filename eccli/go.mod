module originagent-evolution-chain/eccli

go 1.22

require (
	chainmaker.org/chainmaker/pb-go/v2 v2.3.8
...
require (
	...
	chainmaker.org/chainmaker/utils/v2 v2.3.8 // indirect
...
replace chainmaker.org/chainmaker/sdk-go/v2 => ../sdk-go
