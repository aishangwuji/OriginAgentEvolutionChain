...
EC-5 proves the local Anvil transaction path for identity, module, evidence, challenge, resolution, and chain readback. It does not create Points rewards, Credit Deductionable Commitment, public testnet deployment, DAO governance, or Production Network reputation.
