...
challenge-summary: generated invalidated evidence and contribution standing deltas
...
EC-4 challenge state and reputation are sandbox-only. Remote validation proves the runner path works on an independent lightweight host; it does not create Points rewards, Credit Deductionable Commitment, or Production Network reputation.
