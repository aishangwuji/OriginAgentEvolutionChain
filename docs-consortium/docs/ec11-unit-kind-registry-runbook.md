...
EC-11 does not add Contribution Points, contribution points economics, DAO governance, staking, or module marketplace settlement.
...
Artifacts must not contain prompts, facts, raw telemetry, local paths, URL query strings, private keys, API keys, Points, or secret-like strings.
