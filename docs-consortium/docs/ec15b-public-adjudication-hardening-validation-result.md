...
Challenge bond remains off-chain Contribution Points artifact only.
No real Points, staking, Credit Deduction, DAO, marketplace settlement, node Validation Work reward, or airdrop-like point system was introduced.
```
