...
EC-13 translates EC-12 abuse signals into machine-readable gate recommendations before Contribution Points, marketplace incentives, Points rewards, staking, Credit Deduction, or DAO governance.
...
EC-13 is a policy interpretation layer. It does not create economic consequences. Contribution Points, marketplace ranking, Points rewards, staking, Credit Deduction, reputation-weighted voting, and DAO governance remain later phases.
