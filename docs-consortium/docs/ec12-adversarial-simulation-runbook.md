...
EC-12 adds a controlled abuse lab before Contribution Points, marketplace settlement, Points rewards, or Credit Deduction.
...
The abuse report is audit input only. It does not write chain state, Credit Deduction, reward, or mutate Passport reputation.
...
EC-12 does not scan public networks, attack third-party systems, run malware, add contribution points economics, add staking, add DAO governance, or make abuse signals automatically punitive.
